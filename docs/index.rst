...
.. toctree::
   ...
   GitHub Repository <https://github.com/pwnfo/mapchar>
...
* **Smart Seeking**: Instead of streaming from the beginning, Mapchar can seek directly to a specific word using ``--start`` and ``--end``, keeping memory usage constant and small.
* **Multi-threaded**: Distribute generation intelligently across up to 64 cores.
* **Scriptable**: Robust ``.mapc`` syntax allows breaking rules into easily readable macros and modules.
